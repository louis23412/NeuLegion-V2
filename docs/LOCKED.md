...
registry now stands at **53 entries — 17 bit-exact, 36 invariant, 0
...
proven by `analysis.test.js` (437 checks) with exact reference vectors (the harness additionally
