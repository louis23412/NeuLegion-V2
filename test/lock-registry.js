...
export const SUPPORT_MODULES = Object.freeze({
    ...
    'analyze.js': [
        ...
        // Round 30 additions: the pre-registered roster snapshot/registration and the
        // present-but-empty list-flag guard (BUGS.md #69). The register itself lives in
        // `src/lineage.js` (a data/contract module, kept out of this hot-path list).
