...
`../docs/PLAN-round28.md` — **implemented (P1/P2/P3 code landed; the two operator runs and the
two journal-dependent offline readouts remain)**: it fixed the reading layer (the sizing
...
label-policy/`sig-accel` decisions (`RUN-ANALYSIS.md` §14; `BUGS.md` #53–#59). This
...
(566 checks; the walk-forward harness also has a real-candle end-to-end run in
