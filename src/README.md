...
independence purchase that does not cross the DSR surface, **P5** deferred. This
...
(621 checks; the walk-forward harness also has a real-candle end-to-end run in
